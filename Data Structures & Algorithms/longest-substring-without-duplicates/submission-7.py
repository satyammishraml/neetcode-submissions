...
key :
When s[R] is already in the window, keep dropping characters from the left until that duplicate is the one dropped.

If adding s[R] would create a duplicate, shrink the window from the left until the earlier copy is gone.
